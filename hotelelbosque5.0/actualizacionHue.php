...
$Query = "update huesped set nombre = '".$_POST["Nombre"]."', apellidos = '".$_POST["Apellidos"]."', edad = ".$_POST["Edad"]." , sexo = '".$_POST["Sexo"]."', email = '". $_POST["Email"]."', telefono = '".$_POST["Telefono"] ."', ciudad = '".$_POST["Ciudad"] ."', contraseña = '".$_POST["Contraseña"]."' WHERE id_huesped=".$_GET["id"].";";
