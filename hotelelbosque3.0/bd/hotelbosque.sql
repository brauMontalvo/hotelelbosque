...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2021 a las 05:08:11
...
(1, 'Alberto', 21, 'Masculino', 'seccion2', 'Maletero'),
(2, 'Aranza', 27, 'Femenino', 'seccion4', 'Limpieza'),
(3, 'Kevin', 32, 'Masculino', 'seccion3', 'Barman');
...
INSERT INTO `huesped` (`id_huesped`, `nombre`, `edad`, `sexo`, `email`, `telefono`, `ciudad`, `contraseña`) VALUES
(1, 'Aldair', 21, 'Masculino', '123', '21313213', 'Orizaba', '456'),
(2, 'Sergio', 21, 'valor1', 'dunc4nf1r3@gmail.com', '25792135', 'Orizaba', '12345'),
(3, 'Braulio', 21, 'Masculino', 'lauxrobi@gmail.com', '3499867761', 'Canada', '54321'),
(4, 'Julian Casablancas', 41, 'Masculino', 'julian@gmail.com', '45898237', 'Paris', '12345');
...
--
ALTER TABLE `huesped`
  MODIFY `id_huesped` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `reservacion`
  MODIFY `id_reservacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
